...
const blogPosts = [
  {
    id: 1,
    title: " mujsdjfl10 Tips for Small Business Success in 2024",
    excerpt:
      "Running a successful small business in 2024 requires adapting to new technologies, changing consumer behaviors, and evolving market conditions. Here are ten essential tips to help your business thrive.",
    ...
    readTime: " read",
    featured: true,
    tags: ["Business", "Tips", "Success", "2024", "Growth"],
  },
  {
    id: 2,
    title: "The Ultimate Guide to Local SEO",
    excerpt:
      "Local SEO is crucial for businesses that serve customers in specific geographic areas. This comprehensive guide will help you optimize your online presence to attract more local customers.",
    author: "Mike Chen",
    date: "2024-01-12",
    category: "Marketing",
    image: "/placeholder.svg?height=300&width=400",
    readTime: "8 min read",
    featured: false,
    tags: ["SEO", "Local", "Marketing", "Google", "Business"],
  },
  {
    id: 3,
    title: "Building Customer Loyalty in the Digital Age",
    excerpt:
      "Customer loyalty programs have evolved significantly with digital transformation. Learn how to create meaningful connections with your customers and build lasting relationships.",
    ...
    readTime: "6 min read",
    featured: true,
    tags: ["Customer Service", "Loyalty", "Digital", "Relationships"],
  },
  {
    id: 4,
    title: "Social Media Marketing for Local Businesses",
    excerpt:
      "Discover effective social media strategies specifically designed for local businesses. Learn how to engage your community and drive foot traffic to your store.",
    author: "David Park",
    date: "2024-01-08",
    category: "Marketing",
    image: "/placeholder.svg?height=300&width=400",
    readTime: "7 min read",
    featured: false,
    tags: ["Social Media", "Marketing", "Local", "Community"],
  },
  {
    id: 5,
    title: "Financial Planning for Small Business Owners",
    excerpt:
      "Effective financial planning is crucial for business success. Learn about budgeting, cash flow management, and financial strategies that can help your business grow.",
    ...
    readTime: "9 min read",
    featured: false,
    tags: ["Finance", "Planning", "Budget", "Cash Flow"],
  },
  {
    id: 6,
    title: "The Future of E-commerce for Small Businesses",
    excerpt:
      "E-commerce continues to evolve rapidly. Explore the latest trends and technologies that small businesses can leverage to compete in the digital marketplace.",
    author: "Alex Kim",
    date: "2024-01-03",
    category: "Technology",
    image: "/placeholder.svg?height=300&width=400",
    readTime: "6 min read",
    featured: true,
    tags: ["E-commerce", "Technology", "Digital", "Future"],
  },
]
