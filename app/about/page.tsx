...
export default function AboutPage() {
  ...
  const services = [
    {
      ...
      description: "Comprehensive listing platform for local businesses",
    },
    {
      icon: "⭐",
      title: "Review System",
      description: "Authentic customer reviews and ratings",
    },
    {
      icon: "📈",
    ...
    },
    {
      ...
      description: "Promotional features to boost visibility",
    },
  ];
  ...
  const features = [
    "Free business listings with premium upgrade options",
      ...
      <section className="relative pt-32 pb-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              We're revolutionizing how local businesses connect with their communities through innovative technology and genuine care.
            </motion.p>
          </motion.div>
        </div>
      </section>
            ...
            >
              <motion.div variants={fadeIn}>
                ...
                <p className="text-gray-700 dark:text-gray-300 mb-6 text-lg leading-relaxed">
                  At Cricaismus, we believe that strong local businesses are the backbone of thriving communities. Our
                  platform serves as a bridge, connecting customers with the businesses they need while helping
                  entrepreneurs reach new audiences.
                </p>
              </motion.div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          >
            ...
            <p className="text-xl md:text-2xl opacity-90 leading-relaxed">
              Whether you're a business owner or a customer, we'd love to have you as part of the Cricaismus family.
            </p>
